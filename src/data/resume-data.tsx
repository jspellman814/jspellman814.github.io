...
export const RESUME_DATA = {
  ...
  summary:
    "I'm an experienced software engineer with a passion for delivering innovative solutions that empower organizations and users alike. My specialties include: leading software development life cycles with agile methodologies, leveraging cutting-edge technologies to build responsive/standards-compliant websites, integrating modern technologies into existing workflows, introducing best practices, designing and implementing technical architecture, enabling unique and tailored solutions for clients and, lastly, conducting peer code reviews and acting as a subject matter expert in web development matters. My vision is to continually push the boundaries of web engineering, contributing to the evolution of user-centric and innovative solutions. Through effective collaboration with clients and internal teams, I strive to translate concepts into reality while ensuring that every project is a testament to engineering excellence and user satisfaction.",
